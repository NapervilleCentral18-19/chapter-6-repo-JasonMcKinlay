...
public class Account implements Comparable
{
   ...
   public String toString ()
   {
    ...
    public int compareTo (Object o)
    {
            ...
            return this.getAccountNumber() - a.getAccountNumber();
    }


    public int hashCode()
    {
        int hash_num = acctNumber;
        int temp = 0;
        int factor = 10007;
        
        //if acctNumber is low like 1 or 2, it'll keep multiplying by factor until reaches 8 digits
        while (hash_num < 10000000) {
            hash_num *= factor; }
            
        //if hash_num is over 8 digits, it'll divide by 10 to remove a digit 
        while (hash_num > 99999999) {
            hash_num /= 10;
        }
